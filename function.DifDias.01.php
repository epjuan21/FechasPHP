...
// Separo Año Mes y Dia con la Funcion substr

$year_date_1 = substr($fecha1,0,4);
$month_date_1 = substr($fecha1,5,2);
$day_date_1 = substr($fecha1,8,9);

$year_date_2 = substr($fecha2,0,4);
$month_date_2 = substr($fecha2,5,2);
$day_date_2 = substr($fecha2,8,9);
...
// Para convertir los segundos en días, como se ha podido observar en el código, 
// hay que dividir entre el número de segundos de un día. 
// (60 segundos de un minuto, por los 60 minutos de una hora, por las 24 horas de un día). 

// Ahora bien, con un código como el anterior, 
// el valor de los días de diferencia puede tener decimales y ser negativo. 
// Nosotros queremos un número de días entero y positivo. 
// Entonces todavía tendremos que hacer un par de operaciones matemáticas. 
...
// Los decimales los quitamos simplemente redondeando hacia abajo. 
// Puesto que si tenemos un número decimal de días no ha llegado a un día completo y no nos interesa contabilizarlo. 
